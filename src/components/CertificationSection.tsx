import { Award, Shield, FileCheck, Wrench, Check } from 'lucide-react';
  ...
  const certifications = [
    {
      id: 'iso-9001',
      title: 'ISO 9001',
      authority: 'System Quality Assured',
  ...
  return (
    <section id="certifications-section" className="py-24 bg-transparent border-t border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        {/* High-Contrast Monochrome Certification Grid (4 Columns) */}
            ...
            return (
              ...
              >
                <div>
                  ...
                  <p className="font-mono text-[9px] text-slate-500 font-bold uppercase tracking-wider mb-4">
                    {cert.authority}
                  </p>
